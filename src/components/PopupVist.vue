...
// Propiedad para almacenar el ID de la propiedad seleccionada
const name = ref('');
const phone = ref('');
const timeSlot = ref('');
const propertyId = ref(''); // Agregar el ID de la propiedad
const isPopupOpen = ref(true);
...
async function submitForm() {
  const formData = {
    ...
    phone: phone.value,
    timeSlot: timeSlot.value,
    propertyId: propertyId.value  // Enviar el ID de la propiedad
  };
...
// Función para abrir el popup y asignar el propertyId
function openPopup(id) {
  propertyId.value = id; // Asignar el ID de la propiedad seleccionada
  isPopupOpen.value = true; // Abrir el popup
}
</script>
