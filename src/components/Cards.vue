...
import { useSearchStore } from '../stores/searchStore';
import { useRoute } from 'vue-router';
import visitbutton from '@/components/VisitButton.vue'; // Importamos el botón de visita con el popup
  ...
  <div class="properties-list">
    ...
    <div v-for="(property, index) in properties" :key="index" class="card">
      ...
      <div class="content">
        ...
        <div class="features">
          <!-- Features como dormitorios, baños, etc. -->
        </div>
        <div class="actions">
          <!-- Aquí añadimos el botón con el popup integrado -->
          <visitbutton /> <!-- Colocamos el botón dentro de la card -->
